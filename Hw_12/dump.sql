...
COPY public.classes (id, class_name, classroom_teacher) FROM stdin;
...
COPY public.students (id, first_name, last_name, class_id) FROM stdin;
...
COPY public.teachers (id, first_name, last_name) FROM stdin;
1	Ivan	Petrov
2	Petr	Ivanov
3	Alexandr	Sidorov
\.
